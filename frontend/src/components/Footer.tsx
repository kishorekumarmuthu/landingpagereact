...
export function Footer() {
  return (
    <>
      <div className="xs:ml-6 xs:mt-20 md:ml-[210px] w-3/4 md:mt-[280px] flex gap-3 flex-col">
        <div className="flex xs:flex-col md:flex-row gap-5">
          <div className="xs:w-full md:w-1/5 flex flex-col gap-3">
          ...
          <div className="xs:w-full md:w-1/5 flex flex-col gap-3 items-start">
          ...
          <div className="xs:w-full md:w-1/5 flex flex-col gap-4 items-start">
        ...
        <hr className="w-[100%] h-px my-8 bg-gray-500 border-0" />
        <div className="flex xs:flex-col md:flex-row gap-6 justify-between mb-10">
